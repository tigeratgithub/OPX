  ...
  */
		...
		modFrame.request == FALSE)
	{
		if (modFrame.heartbeat == TRUE)
		{
			...
			modFrame.data[4] = 3;
			modFrame.data[5] = 3;			
			modFrame.heartbeat = FALSE;
			mod_master_send(1, WriteMultiRegs, 100, 6);
		} else {
			modFrame.data[0] = 2;
			modFrame.data[1] = 2;
			modFrame.data[2] = 1;
...
extern s32 adc1_sum;
extern s32 adc1_sumcount;
extern _Bool adc1_update;
/**
